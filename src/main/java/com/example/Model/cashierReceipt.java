...
public class cashierReceipt extends receipt {
    ...
    public cashierReceipt(int totalPrice, Vector<Pair<Product, Integer>> itemList) {
        super(totalPrice, itemList);
    }

    public cashierReceipt(int totalPrice, Date date, Time time, Vector<Pair<Product, Integer>> itemList) {
    ...
    public static void addCashierReceipt(int _totalPrice, Vector<Pair<Product, Integer>> _itemList) {
